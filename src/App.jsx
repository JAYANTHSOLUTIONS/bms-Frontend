...
import EditEventForm from './component/events/EditEventForm'
import EditEventCard from './component/events/EditEventCard'
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path="/editeve/:id" element={<EditEventCard/>}/>
        ...
        <Route path="/explore/event" element={<EventsPage/>}/>
